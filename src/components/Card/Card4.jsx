    ...
    <div className="flex flex-col">
      {portfolio.map((e, index) => {
        return (
          ...
          >
            <div className=" flex flex-col ml-8 w-50 text-blue-100 opacity-70 text-xs ">
              {language ? e.stage :e.etapa}
              <span
                style={{
            ...
            <div className="flex flex-col opacity-70 ">
              <motion.div
                className="text-blue-100 text-justify justify-around flex text-xs"
              ...
              >
                ...
                <div className=" flex ml-2 gap-2 flex-row-reverse">
                  ...
                  <a href={e.hub} >{e.published && <p className='blinker'>PUBLISHED</p>}</a>
                  <Rating rating={e.rating} />
                </div>
              </motion.div>
              <div className="flex justify-start flex-col p-5 gap-2">
                <motion.img
                  className="w-80 shadow-xs  shadow-blue-100 border-white border-double"
                  src={e.img}
                />
                <motion.p className="w-96 text-start text-blue-100 leading-relaxed opacity-50 ">
