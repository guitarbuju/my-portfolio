...
const About = () => {
  ...
  return (
    <div className="flex gap-10 justify-center flex-row ">
      ...
      <AnimatePresence>
        <motion.div
          className="mt-40 fixed about-container"
      ...
      <div className=" flex-col items-center">
        ...
        <div className="flex align-middle justify-center gap-2  mb-2  ">
          ...
          <h2 className="text-blue-100 text-2xl opacity-60 mt-2">
            {language ? "Developer" : "Desarrollador"}
          </h2>
          <p className="text-blue-100  opacity-40 mt-0 text-sm">
            {language
              ? "inspiring, engaging and functional development"
              : "desarrollo funcional que conecta e inspira ..."}
          </p>
      ...
      <div className="mt-20 mb-10 " style={{ marginLeft: "30vw" }}>
